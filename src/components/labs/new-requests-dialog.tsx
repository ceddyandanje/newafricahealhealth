...
import { User, FlaskConical, Calendar, Clock, CheckCircle, Info, Beaker, Package, Check } from 'lucide-react';
...
interface NewRequestsDialogProps {
    requests: LabRequest[];
    isOpen: boolean;
    onClose: () => void;
}
...
export default function NewRequestsDialog({ requests, isOpen, onClose }: NewRequestsDialogProps) {
            ...
            <DialogContent className="sm:max-w-3xl">
                <DialogHeader>
                    <DialogTitle className="flex items-center gap-2 font-headline text-2xl">
                        <Beaker /> New Lab Requests
                    </DialogTitle>
                    <DialogDescription>
                        Review and process incoming test requests.
                    </DialogDescription>
                </DialogHeader>
                           ...
                           <Card key={request.id} className="overflow-hidden">
                                ...
                                <CardContent className="p-4 space-y-3">
                                    ...
                                    <div className="flex gap-2 pt-3 border-t">
                                        <Button size="sm" className="flex-1" onClick={() => handleUpdateStatus(request.id, 'In Progress', request.testName)}>
                                            <FlaskConical className="mr-2 h-4 w-4" /> Acknowledge & Start Test
                                        </Button>
                                    </div>
                                </CardContent>
                           </Card>
                            ...
                            <div className="text-center text-muted-foreground py-16">
                                ...
                                <p className="text-sm">New test requests will appear here live.</p>
                            </div>
                        )}
                    </div>
                </ScrollArea>
