...
import { 
    LayoutDashboard, Map, ListOrdered, Settings, LogOut, Truck
} from 'lucide-react';
...
const navItems = [
    ...
    { href: '/delivery/routes', icon: Map, label: 'My Routes' },
    { href: '/delivery/orders', icon: ListOrdered, label: 'Order History' },
];
...
export default function DeliverySidebar() {
    ...
    return (
        <aside className="fixed left-0 top-0 h-full w-20 flex flex-col items-center py-4 bg-background border-r z-50">
            <Link href="/delivery/dashboard" className="mb-6">
