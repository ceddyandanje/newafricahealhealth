    ...
    return (
      <div className="bg-background">
         <section className="relative h-[50vh] min-h-[400px] flex items-center justify-center text-center text-white">
            <Image
                src="https://images.unsplash.com/photo-1559757296-c68c34d39551?q=80&w=1031&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            ...
            <div className="relative z-10 p-4">
                <h1 className="text-4xl md:text-6xl font-bold font-headline">Organ Transplant Solutions</h1>
                <p className="text-lg md:text-xl max-w-3xl mx-auto mt-4">
                    Coordinating life-saving transplants and providing professional-grade support.
                </p>
            </div>
        </section>
